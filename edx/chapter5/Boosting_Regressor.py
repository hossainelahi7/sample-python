...
basemodel = DecisionTreeRegressor(max_depth=1, random_state=0)
...
dtr = DecisionTreeRegressor(max_depth=1, random_state=0)
...
boosted_model = GradientBoostingRegressor(n_estimators=1000, max_depth=1, learning_rate=l_rate, random_state=0)
...
model = BaggingRegressor(n_estimators=num_bootstraps, max_samples=0.8, random_state=3)
